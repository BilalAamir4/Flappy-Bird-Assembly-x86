...
; ============================================================
; RANDOMIZE PIPE — pick a new gap_top using BIOS timer
...
randomize_pipe:
    ...
    mov al, dl          ; low byte — changes most rapidly
...
.reset_pipe:
    mov byte [pipe_x], 79
    mov byte [old_pipe_x], 79
    call randomize_pipe         ; ← new random gap every pipe cycle
